...
pub struct OwnerEditorProps {
    pub owners: HashSet<String>,
    pub replacements: HashMap<String, String>,
    pub on_update: Callback<HashMap<String, String>>,
}

#[function_component(OwnerEditor)]
pub fn owner_editor(props: &OwnerEditorProps) -> Html {
    ...
    let on_change = {
        ...
        Callback::from(move |(name, value): (String, String)| {
            ...
            console::log_1(&format!("✅ Owner modifié: {} → {}", name, value).into());
    ...
    html! {
        <div class="">
            <h3>{ "Owner:" }</h3>
            {
               for props.owners.iter().map(|name| {    
                    ...
                    html! {
                        <div class="grid auto-cols-max grid-flow-col p-1">
                            ...
                            <input
                                ...
                                value={value.clone()}
                                placeholder="variable ex: autosys_sa"
                                oninput={
                                    let name = name.clone();
